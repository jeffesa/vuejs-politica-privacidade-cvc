...
let aboutUs = {
  ...
  column2: {
    description: 'O comprometimento social, a solidez e a inovação trouxeram notoriedade e visibilidade junto ao público. A CVC foi a primeira companhia a:',
    list: [
      {
        icon: baseImage([
      ...
      },
      {
        ...
        text: 'investir em um novo canal de distribuição com rede multimarca de produtos turísticos;'
      },
      {
        icon: baseImage([
          {src: '/about_us/baggage.svg, /about_us/baggage.svg', query: '(max-width: 1023px)'},
          {src: '/about_us/baggage.svg, /about_us/baggage.svg'},
        ], '', ''), 
        text: 'desenvolver o atendimento em shoppings e hipermercados;'
      },
      {
        icon: baseImage([
          {src: '/about_us/card.svg, /about_us/card.svg', query: '(max-width: 1023px)'},
          {src: '/about_us/card.svg, /about_us/card.svg'},
        ], '', ''), 
        text: 'oferecer o parcelamento de viagens em 10 (dez) vezes sem juros, com valores que cabem no bolso do consumidor.'
      },
    ],
    information: 'Embarque nessa com a gente, aperte os cintos e tenha uma excelente aventura!'
  }
}
///////////////////////////////////
// DocumentPurpose
...
let documentPurpose = {
  ...
  title: 'O propósito do documento',
  card: '<strong>A proteção dos seus Dados Pessoais é muito importante para a CVC</strong>. Levamos esse assunto muito a sério e é nossa prioridade garantir a segurança e a proteção dos seus Dados Pessoais em qualquer contato conosco, seja por meio do nosso site, aplicativo ou em uma das nossas lojas físicas ao redor do Brasil.',
  information: 'A CVC pretende demonstrar por meio desse documento nosso comprometimento em tratar seus Dados Pessoais com segurança, garantindo que todas as operações realizadas tenham máxima transparência.',
  list: {
    ...
    items: [
      ...
      'como sua segurança é garantida e a sua privacidade respeitada.'
    ]
  },
  moreInformation: 'Não há previsão de turbulência por aqui! O cuidado que a CVC tem com seus Dados Pessoais não poderia ser diferente daquele que temos com toda a realização dos seus sonhos junto conosco.',
  image: baseImage([
...
let privacyPolicy = {
  ...
  informations: [
    `Esta Política de Privacidade se aplica a todos que utilizam a Plataforma da CVC, bem como aos que tenham seus Dados Pessoais tratados pela CVC. A utilização da Plataforma pelo Usuário implica na ciência desta Política de Privacidade.
     <br><br>Assim, esta Política de Privacidade aplica-se a todos Serviços oferecidos pela CVC, inclusive quando Você:`,
    `Que tal alguns exemplos? A presente Política se aplica aos dados fornecidos por Você ao criar uma conta em nossa Plataforma, solicitar cotação/contratação de Serviços, trocar mensagens ou contatar de alguma outra forma a CVC ou, ainda, em outras situações nas quais Você tenha contato com nossos Serviços, como ao navegar ou fazer qualquer uso de nossa Plataforma.
     <br><br>Esta Política também será aplicável aos Dados Pessoais coletados de forma automática pela CVC quando Você acessa nossa Plataforma (ex: seu endereço IP, data e hora), assim como aos Dados seus que recebemos de alguns terceiros.`,
    `A utilização de dados específicos para a prestação de cada Serviço não descrita nesta Política, será disciplinada no respectivo contrato aplicável ao Serviço.`
  ],
  list: [
    {
      icon: baseImage([
        {src: '/privacy_policy/earth.svg, /privacy_policy/earth.svg'},
      ], '', ''), 
      text: 'Acessa ou utiliza nossa Plataforma através do site <strong>“www.cvc.com.br”</strong> ou do aplicativo <strong>“Minha CVC”</strong>;'
    },
    {
      icon: baseImage([
        {src: '/privacy_policy/store.svg, /privacy_policy/store.svg'},
      ], '', ''), 
      text: 'Interage conosco em nossas Lojas;'
    },
    {
      icon: baseImage([
        {src: '/privacy_policy/services.svg, /privacy_policy/services.svg'},
      ], '', ''), 
      text: 'Utiliza os Serviços CVC.'
    }
  ],
  card: '<strong>Atenção!</strong> Essa Política não se aplica a sites ou serviços de terceiros. Por isso, recomendamos que Você sempre leia as Políticas de Privacidade desses terceiros para compreender como seus dados serão tratados, pois não podemos nos responsabilizar ou controlar seu conteúdo.'
}
///////////////////////////////////
// DataController
///////////////////////////////////
...
let personalData = {
  ...
  storePlatform: {
    ...
    grid: {
      data: {
        text: 'Podemos coletar as suas informações por dois meios:',
        places: [
          {
            icon: baseImage([
      ...
      information: 'Em relação às <strong>Lojas</strong>, a CVC poderá coletar informações fornecidas diretamente por Você em nossas Lojas Próprias ou através de terceiros, como franquias ou outras Lojas autorizadas a vender nossos Serviços. ',
      arrow: baseImage([
        {src: '/personal_data/arrow_icon.svg, /personal_data/arrow_icon.svg'},
      ], '', ''), 
    },
    details: 'Vamos entender como isso funciona? Sempre que você interage conosco, poderemos coletar e tratar seus Dados Pessoais para os fins descritos nesta Política, conforme abaixo:',
  },
  dataProvided: {
    title: 'Dados fornecidos por você:',
    description: `<strong>os Dados Pessoais tratados pela CVC poderão variar a depender do Serviço contratado, bem como preferências que Você definir. <br><br>Ao interagir conosco, como cliente/comprador direto, usuário de nossos sites, app “Minha CVC” ou, até mesmo como acompanhante(s), os Dados Pessoais na coluna ao lado podem ser compartilhados com a CVC.</strong>`,
    list: [
      {
      ...
      },
      {
        ...
        description: 'para dar andamento à contratação de alguns Serviços, poderemos solicitar dados complementares para a análise de crédito, análise de fraude e posterior formalização do contrato. Tais dados incluem: digitalização de documento de identificação com assinatura (por exemplo, RG ou CNH), nacionalidade, profissão, cargo e filiação. Lembre-se que nestes casos, a CVC também poderá receber informações sobre Você de prestadores de serviço que são parte do processamento de pagamento e análise de fraude, ok?'
      },
      {
        title: 'Informações de acompanhante(s) e outras pessoas:',
        description: 'caso não seja o único a se beneficiar de nossos Serviços de turismo, Você deverá fornecer as informações necessárias para que a CVC possa fornecer os Serviços também para o(s) acompanhante(s) ou para a pessoa na qual Você está contratando nossos Serviços. Neste caso, iremos tratar as “informações cadastrais” e “de preferência” para podermos garantir o fornecimento dos nossos Serviços. <br><br>Caso os acompanhantes sejam crianças ou adolescentes, a CVC compromete-se a sempre tratar tais Dados Pessoais no melhor interesse da criança ou do adolescente, nos limites das leis aplicáveis, podendo tratar nome completo, telefone, sexo e data de nascimento.'
      },
      {
        title: 'Documentação comprobatória em caso de reembolso ou revisão de multa: ',
        description: 'caso algum evento te impeça de usufruir um Serviço já contratado, poderá ser necessário compartilhar conosco informações e documentos que comprovem a ocorrência desse evento, que poderão revelar Dados Sensíveis, inclusive de saúde, próprios ou de terceiros. Tais documentos podem incluir, atestado de saúde, certidão de óbito, certidão de nascimento, dentre outros, a depender do caso concreto.'
      },
      {
  ...
  dataPlatform: {
    ...
    moreInformation: 'Caso Você se cadastre junto a nossa Plataforma, criando uma conta de acesso, além da navegação, a CVC poderá coletar outros Dados Pessoais, conforme indicado acima.'
  },
  dataShared: {
  ...
  lgpd: 'Em todos os casos, a CVC compromete-se a manter todos os dados em <strong>confidencialidade absoluta</strong>, tratando somente os Dados Pessoais necessários para prestação dos Serviços, cumprimento de alguma obrigação legal ou, ainda, com fundamento em outras hipóteses previstas na LGPD.'
}
///////////////////////////////////
      ...
      topList: [
        {
          ...
          list: [
            {
              text: '<span>&#9992;</span> Enviar comunicações de marketing por e-mail ou SMS e realizar as demais ações de marketing, inclusive marketing direcionado, para promover a CVC, as demais empresas do Grupo CVC Corp ou parceiros de negócio;'
            }
          ]
        },
        {
          ...
          list: [
            {
              text: '<span>&#9992;</span> Controlar a performance da CVC, aprimoramento das iniciativas comerciais e promocionais da CVC e melhoria da sua experiência ao navegar em nossa Plataforma;'
            }
          ]
        },
        {
      ...
      topList: [
        {
          ...
          list: [
            {
              text: '<span>&#9992;</span> Assegurar o cumprimento de leis, normas, resoluções, acordos, medidas provisórias ou qualquer outra obrigação legal que a CVC precise cumprir.'
            }
          ]
        }
      ]
  ...
  topics: [
    {
      ...
      services: [
        ...
        {
          number: 'iv',
          text: 'Prestadores de serviço para fins de fornecimento de software e outros sistemas de tecnologia da informação que auxiliam na prestação dos Serviços, gestão de clientes e da relação com franqueados;'
        },
        {
          number: 'v',
          text: 'Fornecedores de serviços de valor agregado que Você poderá adquirir quando celebra um contrato com a CVC (por exemplo, seguro-viagem, câmbio, assessoria de obtenção de visto ou passaporte);'
        },
        {
          number: 'vi',
        ...
        {
          number: 'vii',
          text: 'Mídias sociais para fins de marketing da CVC.'
        },
      ],
      image: baseImage([
    ...
    {
      title: 'b.	Situações definidas por lei: ',
    ...
    },
    {
      ...
      description: 'A CVC também poderá compartilhar dados anonimizados com:',
      provider: [
...
let personalDataTransfer = {
  ...
  text: 'Quando necessário, podemos compartilhar os seus Dados Pessoais com as empresas do Grupo CVC Corp sediadas fora do Brasil para realizar as atividades especificadas na presente Política. <br><br>A CVC ainda pode igualmente subcontratar ou compartilhar os seus Dados Pessoais com terceiros localizados em outros países, incluindo prestadores de serviços em nuvem. Caso Você, por exemplo, contrate pacotes de viagem com destino fora do país, será necessário transferir seus Dados Pessoais para que os fornecedores possam prestar tais Serviços.',
  card: 'De todo modo, fique tranquilo! Adotamos as medidas apropriadas para garantir a proteção de seus dados pessoais em conformidade com os requisitos da legislação aplicável e dispositivos contratuais adequados.',
  image: baseImage([
...
let cookiesTechnologies = {
  ...
  todo: {
    title: 'A CVC pode utilizar cookies para:',
    image: baseImage([
    ...
    description: '<strong>Nós contabilizamos o clique identificando juntamente ao ID do usuário que clicou</strong>, no caso de usuários cadastrados. <br><br>Além dos cookies e outras tecnologias semelhantes da CVC, podemos permitir que terceiros contratados utilizem seus próprios cookies ou tecnologias para prestação de serviços à CVC.'
  }
}
///////////////////////////////////
// Data Stored
...
let dataStored = {
  ...
  information: 'Os Dados Pessoais tratados para as finalidades descritas nesta Política serão armazenados pela CVC apenas pelo período necessário para atingirem a finalidade para os quais foram coletados, como, por exemplo, durante o período em que o Titular de dados possuir um contrato vigente com a CVC, ou ainda, pelo tempo necessário para: ',
  title: 'Como seus dados são armazenados?',
  icon: baseImage([
  ...
  list: {
    items: [
      ...
      '<span>&#9992;</span> atendimento dos interesses legítimos da CVC ou de terceiros, respeitadas as legítimas expectativas do Titular de Dados Pessoais.'
    ]
  },
...
let validity = {
  ...
  text: "<p>A CVC busca aperfeiçoar suas atividades cotidianamente, de modo que poderá atualizar e alterar esta Política a qualquer momento, visando, principalmente, fornecer ao Titular um nível de transparência cada vez maior sobre a forma como seus Dados Pessoais serão tratados.</p><p>Caso esta Política sofra modificações relevantes, a CVC irá divulgar sua versão mais recente, além de dar ciência aos Titulares de dados, por meio de seus canais oficiais de comunicação, acerca das novas condições para o Tratamento de seus Dados Pessoais.</p><p><strong>Esta Política de Privacidade foi atualizada e revisada em outubro de 2021.<strong></p>",
}
///////////////////////////////////
// Contact
///////////////////////////////////
let contact = {
  component: 'Contact',
  name: 'contact',
  title: 'Como entrar em <br>contato com a CVC?',
  text: '<p>Ficou com dúvida? Entre em contato conosco por meio do nosso canal de atendimento oficial <a href="www.cvc.com.br">clicando aqui</a>.</p>',
  imageSun: baseImage([
...
let faq = {
  ...
  aTitle: '<strong>a. “CVC”, “nós”, “nosso/a”:</strong>',
  aText: 'toda vez que houver menção a esses termos estaremos nos referindo à CVC BRASIL OPERADORA E AGÊNCIA DE VIAGENS S/A;',
  bTitle: '<strong>b. “Usuário”, “Você”, “seu” ou “sua”:</strong>',
  bText: 'sempre que mencionar esse termo, estamos nos referindo aos nossos clientes, usuários de nossas Plataformas, quem adquiriu nossos Serviços, acompanhante(s) e qualquer outra pessoa que interaja com a CVC;',
  cTitle: '<strong>c. “Plataforma”:</strong>',
  cText: 'refere-se ao site “www.cvc.com.br” ou ao aplicativo “Minha CVC”;',
  ...
  eText: 'documento pelo qual a CVC esclarece em detalhes, o Tratamento de Dados Pessoais de clientes que utilizam sua Plataforma, em atendimento à legislação vigente, sobretudo às disposições da LGPD;',
  fTitle: '<strong>f. “Serviço(s)”:</strong>',
  fText: 'todos os serviços oferecidos pela CVC;',
  gTitle: '<strong>g. “Lojas”:</strong>',
  gText: 'lojas físicas ao redor do Brasil;',
  hTitle: '<strong>h. “Dados Pessoais”:</strong>',
  hText: 'informações relacionadas a pessoa natural que a identifiquem, ou que, em combinação com outras informações tratadas, identifiquem um indivíduo. Por exemplo, seu nome, CPF, RG, telefone, dados da sua conta bancária, dentre outros;',
  iTitle: '<strong>i. “Dados Pessoais Sensíveis”:</strong>',
  iText: 'são Dados Pessoais que digam respeito a origem racial ou étnica, convicção religiosa, opinião política, filiação a sindicato ou à organização de caráter religioso, filosófico ou político, bem como dado referente à saúde ou à vida sexual, dado genético ou biométrico;',
  jTitle: '<strong>j. “Titular”:</strong>',
  jText: 'pessoa natural a quem se referem os Dados Pessoais objeto do Tratamento;',
...
let summary = {
  ...
  menu: [
    ...
    { name: personalDataTransfer.name, title: `9. ${personalDataTransfer.title}`, component: personalDataTransfer.component },
    { name: documentPurpose.name, title: `2. ${documentPurpose.title}`, component: documentPurpose.component },
    { name: cookiesTechnologies.name, title:`10. ${cookiesTechnologies.title}`, component: cookiesTechnologies.component },
    { name: privacyPolicy.name, title: `3. ${privacyPolicy.title}`, component: privacyPolicy.component },
    { name: dataStored.name, title: `11. ${dataStored.title}`, component: dataStored.component },
    { name: dataController.name, title: `4. ${dataController.title}`, component: dataController.component },
    { name: dataHolder.name, title: `12. ${dataHolder.title}`, component: dataHolder.component },
    { name: personalData.name, title: `5. ${personalData.title}`, component: personalData.component },
    { name: personalDataSecurity.name, title: `13. ${personalDataSecurity.title}`, component: personalDataSecurity.component },
    { name: personalDataPurposes.name, title: `6. ${personalDataPurposes.title}`, component: personalDataPurposes.component },
    { name: validity.name, title: `14. ${validity.title}`, component: validity.component },
    { name: benefitsProgram.name, title: `7. ${benefitsProgram.title}`, component: benefitsProgram.component },
    { name: contact.name, title: `15. ${contact.title}`, component: contact.component },
    { name: personalDataSharing.name, title: `8. ${personalDataSharing.title}`, component: personalDataSharing.component },
    { name: faq.name, title: `16. ${faq.title}`, component: faq.component },
  ]
}
...
let header = {
  ...
  name: 'header',
  imageLogo: baseImage([
    {src: '/cvc_logo.png, /cvc_logo.png', query: '(max-width: 1023px)'},
    {src: '/cvc_logo.png, /cvc_logo.png'},
  ], '', ''), 
  imageLocation: baseImage([
    {src: '/location_header.png, /location_header.png', query: '(max-width: 1023px)'},
    {src: '/location_header.png, /location_header.png'},
  ], '', ''), 
